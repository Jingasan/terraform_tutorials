...
const rdsHostname = String(process.env.RDS_HOSTNAME); // RDSのホスト名
...
const rdsRegion = String(process.env.RDS_REGION); // RDSを配置したRegion
...
app.get(
  ...
  async (_req: Request, res: Response, _next: NextFunction): Promise<void> => {
    try {
      // RDS関連の情報表示
      console.log(`RDS Hostname: ${rdsHostname}`);
